...
class CreateDiseaseRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'schema.columns.*.name' => 'required|string',
            'schema.columns.*.type' => 'required|string|in:string,integer,decimal,date,file,datetime,boolean,array,float,text,email,phone,json,range',
